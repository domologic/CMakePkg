...
set(_CMAKEPKG_COMPILER_DEFAULT_CATEGORIES  DEFINE FLAGS FLAGS_C FLAGS_CXX FLAGS_ASM FLAGS_ASM_MASM LINK  CACHE INTERNAL "CMakePkg compiler default categories.")
...
function(_add_package_build_data_preserve)
  ...
  if (ZEPHYR)
    set(PACKAGE_SRC_NAME ${KERNEL_BIN_NAME})
    string(REPLACE "\"" "" PACKAGE_SRC_NAME ${PACKAGE_SRC_NAME})
  else()
    set(PACKAGE_SRC_NAME ${PACKAGE_NAME})
  endif()

  file(ARCHIVE_CREATE
    OUTPUT
      ${CMAKE_CURRENT_BINARY_DIR}/${PACKAGE_SRC_NAME}-src.zip
    PATHS
    ...
    if (NOT ZEPHYR)
      ...
      target_compile_options(${PACKAGE_NAME}
        PRIVATE
          ...
          $<$<AND:$<BOOL:"${CMAKEPKG_FLAGS_ASM_MASM}">,$<COMPILE_LANGUAGE:ASM_MASM>>:${CMAKEPKG_FLAGS_ASM_MASM}>
          $<$<AND:$<BOOL:"${CMAKEPKG_FLAGS_ASM_MASM_DEBUG}">,$<COMPILE_LANGUAGE:ASM_MASM>,$<CONFIG:Debug>>:${CMAKEPKG_FLAGS_ASM_MASM_DEBUG}>
          $<$<AND:$<BOOL:"${CMAKEPKG_FLAGS_ASM_MASM_RELEASE}">,$<COMPILE_LANGUAGE:ASM_MASM>,$<CONFIG:Release>>:${CMAKEPKG_FLAGS_ASM_MASM_RELEASE}>
          $<$<AND:$<BOOL:"${CMAKEPKG_FLAGS_ASM_MASM_RELWITHDEBINFO}">,$<COMPILE_LANGUAGE:ASM_MASM>,$<CONFIG:RelWithDebInfo>>:${CMAKEPKG_FLAGS_ASM_MASM_RELWITHDEBINFO}>
