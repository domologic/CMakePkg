...
function(_add_module_load_dependency DEPENDENCY)
  ...
  set(SRC_PATH "${CMAKEPKG_PACKAGES_DIR}/Source/${GROUP}/${PROJECT}")
  set(BIN_PATH "${CMAKEPKG_PACKAGES_DIR}/Binary/${GROUP}/${PROJECT}")
  ...
  if (NOT EXISTS ${BIN_PATH})
    ...
    execute_process(
      COMMAND
        ...
        -DCMAKEPKG_PACKAGES_DIR=${CMAKEPKG_PACKAGES_DIR}
      WORKING_DIRECTORY
        ${BIN_PATH}
      OUTPUT_QUIET
    )
