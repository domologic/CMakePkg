...
function(install_resources resource_list config)
...
function(install_resources resource_list)
  if (NOT "${resource_list}" STREQUAL "")
    install(
      FILES
        ${resource_list}
...
function(install_resource_dirs resource_dirs_list config)
  foreach (RESOURCE_DIR ${resource_dirs_list})
    install(
      DIRECTORY
        ${RESOURCE_DIR}
      CONFIGURATIONS
...
function(install_resource_dirs resource_dirs_list)
  foreach (RESOURCE_DIR ${resource_dirs_list})
    install(
      DIRECTORY
        ${RESOURCE_DIR}
